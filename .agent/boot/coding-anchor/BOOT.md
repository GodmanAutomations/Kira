...
- `protocols/client-pricing-gate.md`
- `protocols/consiglieri-gate.md`
...
- `protocols/power-inversion-gate.md`
- `protocols/performance-review-gate.md`
- `protocols/readiness-checkpoint-gate.md`
- `protocols/research-brief-gate.md`
- `protocols/retrieval-led-skill-routing.md`
- `protocols/seo-audit-gate.md`
- `protocols/statistical-analysis-gate.md`
...
- `skills/client-pricing/SKILL.md`
- `skills/consiglieri-protocol/SKILL.md`
...
- `skills/distribution-physics/SKILL.md`
- `skills/mcda-solver/SKILL.md`
- `skills/micro-commit/SKILL.md`
- `skills/power-inversion/SKILL.md`
...
- `skills/trade-journal-analyzer/SKILL.md`
- `skills/trading-risk-gate/SKILL.md`
- `skills/visual-verify-ui/SKILL.md`
- `skills/zenith-execution/SKILL.md`
