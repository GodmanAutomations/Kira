...
Use this to decide where a task belongs.
...
If Stephen names a repo, app, workflow, or module, enter that surface and obey
its local guidance. Keep this packet as posture, not as the project source of
truth.
