...
|.agent/workflows (24):{start.md,end.md,do.md,autoloop.md,plan.md,research.md,ultrathink.md,diagnose.md,...}
...
| `/autoloop` | `.agent/workflows/autoloop.md` | Bounded multi-slice conductor for efficient verified work |
